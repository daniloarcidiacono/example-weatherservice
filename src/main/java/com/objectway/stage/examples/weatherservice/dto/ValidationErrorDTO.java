...
import com.objectway.stage.examples.weatherservice.utils.Pair;
...
public class ValidationErrorDTO extends ErrorDTO {
	...
	public ValidationErrorDTO(final String message, final Set<ConstraintViolation<?>> constraintViolations) {
		super(message);
		errors = constraintViolations.stream().collect(
			Collectors.toMap(
				(ConstraintViolation<?> x) -> x.getPropertyPath().toString(),
